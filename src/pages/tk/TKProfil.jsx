      ...
      <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-24">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 text-lg leading-relaxed text-justify">
              Sebagai Taman Kanak-kanak berstatus swasta di bawah naungan Dinas Pendidikan Provinsi DKI Jakarta, kami melayani anak-anak usia 3–6 tahun dalam program pendidikan kelompok Bermain A dan B. Sekolah ini lahir dari kebutuhan masyarakat akan pendidikan anak usia dini yang berkualitas dan agamis di tengah dinamika perkotaan yang semakin kompleks.
            </p>
