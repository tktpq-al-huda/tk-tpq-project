  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto min-h-screen animate-[fadeIn_0.5s_ease-out]">
      <div className="text-center mb-20">
        ...
        <p className="mt-6 text-xl text-gray-600 max-w-2xl mx-auto">Kami merancang berbagai aktivitas yang merangsang kreativitas dan perkembangan otak anak di masa <strong>Golden Age</strong>. Klik kegiatan untuk melihat foto-fotonya!</p>
      </div>
